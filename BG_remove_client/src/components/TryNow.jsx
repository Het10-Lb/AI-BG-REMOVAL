  ...
  return (
    <div>
        ...
        <div className="text-center mb-24">
            ...
            <label className="inline-flex gap-3 px-8 py-3.5 rounded-full  cursor-pointer bg-gradient-to-r from-blue-500 to-purple-500 m-auto hover:scale-105 transition-all duration-700" htmlFor="upload2">
